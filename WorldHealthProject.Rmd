...
```{r correlation significance, results='asis'}
cortest_income = cor.test(life$Income.composition.of.resources, life$Life.expectancy, method="pearson", use = "complete.obs")
cortest_school = cor.test(life$Schooling, life$Life.expectancy, method="pearson", use = "complete.obs")
cortest_BMI = cor.test(life$BMI, life$Life.expectancy, method="pearson", use = "complete.obs")
cortest_AIDS = cor.test(life$HIV.AIDS, life$Life.expectancy, method="pearson", use = "complete.obs")

#Correlation of variables table
cor_table = matrix(c("0.725", "<2e-16", "0.752", "<2e-16", "0.568", "<2e-16", "-0.557", "<2e-16"), ncol=2, byrow=TRUE)
colnames(cor_table)=c("Correlation Coefficient", "P-value")
rownames(cor_table)=c("Income", "Schooling", "BMI", "AIDS")
